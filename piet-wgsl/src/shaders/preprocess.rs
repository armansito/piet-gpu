...
pub fn get_imports(shader_dir: &Path) -> HashMap<String, String> {
    ...
    {
        imports.insert("bbox".to_string(), include_str!("../../shader/shared/bbox.wgsl").to_string());
        imports.insert("bump".to_string(), include_str!("../../shader/shared/bump.wgsl").to_string());
        imports.insert("config".to_string(), include_str!("../../shader/shared/config.wgsl").to_string());
        imports.insert("cubic".to_string(), include_str!("../../shader/shared/cubic.wgsl").to_string());
        imports.insert("drawtag".to_string(), include_str!("../../shader/shared/drawtag.wgsl").to_string());
        imports.insert("pathtag".to_string(), include_str!("../../shader/shared/pathtag.wgsl").to_string());
        imports.insert("ptcl".to_string(), include_str!("../../shader/shared/ptcl.wgsl").to_string());
        imports.insert("segment".to_string(), include_str!("../../shader/shared/segment.wgsl").to_string());
        imports.insert("tile".to_string(), include_str!("../../shader/shared/tile.wgsl").to_string());
    }
    imports
}
